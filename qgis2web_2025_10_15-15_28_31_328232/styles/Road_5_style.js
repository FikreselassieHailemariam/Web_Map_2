...
var style_Road_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_Road_5(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_Road_5rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_Road_5rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_Road_5(feature, value);
        ;
